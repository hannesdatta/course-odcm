...
# Project Workplan and Coaching

You'll start working on your project in the course week 3 *before* the coaching sessions start in week 4. The activities below help you to structure your project. Stick to the plan to ensure you can finish the project in time.
...
-   Identify a potential data source (website/API) that contains data that maybe valueble to the broader research community and industry. Use Table 2 in Boegershausen et al. 2022 for refinement.
...
-   Finalise your **data documentation** (Sections 1–6).\
