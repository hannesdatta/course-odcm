...
## Selection of scraping projects I've undertaken (I)
...
## Selection of scraping projects I've undertaken (II)
...
url = 'https://api.music-to-scrape.org/charts/top-tracks'
api_request = requests.get(url)
```

## Quick APIs in Python (II)
...
- Software: open (but geeky) (usable right away, no admin rights required), computer exam on Windows computers; all students are encouraged to explore using the software on the computers on campus (e.g., library, computer rooms)
