...
declare -a FileNames=("course_introduction" "livestream2" "livestream3" "livestream4" "livestream8")
declare -a OutputNames=("00_odcm" "02_livestream" "03_livestream" "04_livestream" "08_livestream")
